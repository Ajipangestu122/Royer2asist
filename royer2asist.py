...
ki = LINETCR.LINE()
ki.login(token='EtBoXzmhZDShNzxygnx9.YyTtOcm2UmjNSs+gNXOvMq.PsXLLUfO09aAatYF5U40rFYlPAGi+++NNPOS69qItqI=')
ki.loginResult()
...
print "login success  ✯✰ʀᴏʏᴇʀsᴛᴇᴀᴍs✰✯" 
reload(sys)
...
╠IZA
╚═════════════
line.me/ti/p/~ajiroyer_12 
line.me/ti/p/~Zf_wrath
"""
...
owner =["u2b263bb71282a739eaf71a124e6de4db"]
...
#----------------------------------------------
                ...
                try:
                    ...
                    if strnum == "off":
                        ...
                        if wait["lang"] == "JP":
                            ...
                            cl.sendText(msg.to,strnum + "使人以�?�??�?�?�?��?��?��??请�??�?")
                except:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Value is wrong")
                    else:
                        cl.sendText(msg.to,"Bizarre ratings")
            elif msg.text in ["強�?��?��??�??�?�:�?��?�","Leave on","Auto leave:on","強�?��?��??�??�?��?�??"]:
              #if msg.from_ in admin:
                if wait["leaveRoom"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"already on")
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"�?�?�?�??")
            elif msg.text in ["強�?��?��??�??�?�:�?��??","Leave off","Auto leave:off","強�?��?��??�??�?��?�??"]:
              #if msg.from_ in admin:
            ...
            elif msg.text in ["�?��??追�? :�?��?�","Add on","Auto add:on","�?��??追�? �?�??"]:
              #if msg.from_ in admin:
                if wait["autoAdd"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"already on")
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"�?�?�?�??")
            elif msg.text in ["�?��??追�? :�?��??","Add off","Auto add:off","�?��??追�? �?�??"]:
              #if msg.from_ in admin:
        ...
        #-----------------------------------------
              ...
              if msg.from_ in owner:
                if msg.toType == 2:
                    ...
                    cl.sendText(msg.to,"???????s????s?? Mau Bersih� Group Sampah Nih")
                    cl.sendText(msg.to,"Karna Ini Group Sampah Jadi Mau Di Bersihin Dulu Yah\n?Jangan Baper...\n?Jangan Nangis\n?Jangan Cengeng\nBawa Enjoy Aja Kawan?")
                    msg.contentType = 13
                    msg.contentMetadata = {'mid': 'u2b263bb71282a739eaf71a124e6de4db'}
                    cl.sendMessage(msg)
...
#-----------------------------------------------
                ...
                ki2.sendText(msg.to,"PONG ????double thumbs up??????Har Har??")
                #ki3.sendText(msg.to,"PONG ????double thumbs up??????Har Har??")
#-----------------------------------------------
      ...
      #-------------Fungsi Banned Send Contact Finish------------------#
              ...
              cl.sendMessage(msg)
              cl.sendText(msg.to,"======================")
              cl.sendText(msg.to,"Itu Creator ???????s????s?? Kami")
                #-------------Fungsi Banned Send Contact Finish------------------#
            elif msg.text in ["Creator1"]:
              msg.contentType = 13
              msg.contentMetadata = {'mid': "u003d0c5e6e2e5ef0486ef45ec7b59f66"}
              cl.sendText(msg.to,"======================")
              cl.sendMessage(msg)
              cl.sendText(msg.to,"======================")
              cl.sendText(msg.to,"Itu Creator ???????s????s?? Kami 1")
